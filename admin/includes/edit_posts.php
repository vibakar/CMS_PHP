...
if (isset($_POST['update_posts'])) {
    ...
    $sql_update = "UPDATE posts SET post_category_id='$post_category_id',post_title='$post_title',post_by='$username',"
            . "post_date=now(),post_image='$post_img',post_content='$post_content',post_tags='$post_tags',"
            . "post_status='$post_status' WHERE post_by='$username' AND post_id=$p_id";
    $result = mysqli_query($con, $sql_update);
    if (!$result) {
        die('not updated' . mysqli_error($con));
    }
    echo "<p class='bg-success'>Post Updated <a href='../view_post.php?p_id=$edit_id'>View Post</a> or <a href='posts.php'>Edit More Posts</a> </p>";
}
?>
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <select class="form-control" name="post_category" >   
            <?php
            $sql_category = "SELECT * FROM categories WHERE cat_id=$p_cat_id";
...
<!--            <option value="<?php echo $cat_id; ?>"><?php echo $cat_title; ?></option>-->
    ...
    <input type="hidden" name="post_by" value="<?php echo $p_by; ?>" class="form-control" />

    <input type="hidden" name="post_status" value="<?php echo $p_status; ?>">
    ...
    <div class="form-group">
        ...
        <textarea rows="10" cols="30" name="post_content" class="form-control" ><?php echo $p_content; ?>

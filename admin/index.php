                ...
                <script type="text/javascript">
                    ...
                    function drawChart() {
                        var data = google.visualization.arrayToDataTable([
                            ['Stats', 'count'],
<?php
$element_text = ['Active posts', 'Draft Posts', 'Comments', 'Approved Comments', 'Unapproved Comments', 'Users', 'Subscribers', 'Categories'];
$element_count = [$post_count, $draft_count, $comments_count, $approved_comment_count, $unapproved_comment_count, $users_count, $subscriber_count, $category_count];
...
?>
                ...
                <div id="columnchart_material" style="width: 1120px; height: 500px;"></div>
            </div>
